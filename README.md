...
```powershell
msiexec /i jt-snmpd-0.9.7-x64.msi /qn MANAGEMENTNETWORKS=192.168.1.0/24 COMMUNITY=your-community
```
...
msiexec /x jt-snmpd-0.9.7-x64.msi /qn

# Uninstall and remove everything
msiexec /x jt-snmpd-0.9.7-x64.msi /qn PURGE=1
```
