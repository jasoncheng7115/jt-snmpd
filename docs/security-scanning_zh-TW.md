...
| 項目 | 工具 / 方法 | 為什麼 |
|---|---|---|
| **Authenticode 簽章** | `signtool verify /pa /v`、Sysinternals `sigcheck` | 本專案不簽章，此項用於確認自行簽章後的結果；見[程式碼簽章](https://jasoncheng7115.github.io/jt-snmpd/code-signing_zh-TW.html) |
