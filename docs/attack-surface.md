...
| Risk | Today | Plan |
|---|---|---|
| **Community string in clear text** | v2c has neither encryption nor authentication and can be sniffed | **SNMPv3 is implemented** (SHA-256 + AES-128 at authPriv, localized keys under DPAPI machine scope). Set `v3_only` to refuse v2c outright |
