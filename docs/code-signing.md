...
Get-FileHash .\jt-snmpd-1.1.1-x64.msi -Algorithm SHA256
Get-Content  .\jt-snmpd-1.1.1-x64.msi.sha256
```
...
```powershell
# CLI
Unblock-File .\jt-snmpd-1.1.1-x64.msi
```
...
signtool verify /pa /v .\jt-snmpd-1.1.1-x64.msi
```
