...
Get-FileHash .\jt-snmpd-0.9.5-x64.msi -Algorithm SHA256
Get-Content  .\jt-snmpd-0.9.5-x64.msi.sha256
```
...
```powershell
# CLI
Unblock-File .\jt-snmpd-0.9.5-x64.msi
```
...
signtool verify /pa /v .\jt-snmpd-0.9.5-x64.msi
```
